    ...
    >
      {PILLS.map((pill) => (
        <a
          key={pill.href}
          href={pill.href}
          className="flex h-9 shrink-0 items-center gap-1 rounded-[20px] border border-kimi-line bg-kimi-panel pr-3 pl-2.5 text-kimi-secondary whitespace-nowrap transition-colors duration-150 hover:bg-kimi-hover hover:text-kimi-primary"
        >
